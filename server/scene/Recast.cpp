							   ...
							   rcHeightfield& hf, rcCompactHeightfield& chf)
{
	...
	if (!chf.cells)
	{
		ACE_DEBUG((LM_ERROR,"rcBuildCompactHeightfield: Out of memory 'chf.cells' (%d)\n", w*h));
		return false;
	}
	...
	if (!chf.spans)
	{
		ACE_DEBUG((LM_ERROR, "rcBuildCompactHeightfield: Out of memory 'chf.spans' (%d)\n", spanCount));
		return false;
	}
	...
	if (!chf.areas)
	{
		ACE_DEBUG((LM_ERROR, "rcBuildCompactHeightfield: Out of memory 'chf.areas' (%d)\n", spanCount));
		return false;
	}
	...
	{
		ACE_DEBUG((LM_ERROR,"rcBuildCompactHeightfield: Heightfield has too many layers %d (max: %d)\n",tooHighNeighbour, MAX_LAYERS));
	}
