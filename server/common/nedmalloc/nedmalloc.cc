...
void nedmallinfo(size_t &arena,size_t &ordblks,size_t &hblkhd,size_t &usmblks,size_t &uordblks,size_t &fordblks,size_t &keepcost)THROWSPEC{
	mallinfo info = nedmallinfo();
	arena = info.arena;
