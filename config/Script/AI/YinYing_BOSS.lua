...
function YinYing_PushOrder(RECEIVER,ARG0,ARG1,ARG2,ARG3,ARG4)
	...
	if myCurHp/myMaxHp >= 0.5 then
		while (ARG4[index] == 2121 or ARG4[index] == 2051) do
...
function YinYing_Born(RECEIVER,ARG0,ARG1,ARG2,ARG3,ARG4)
	local roll = math.ceil(math.random(0,100));
	if roll <= 50 then
		YinYing_PushOrder(RECEIVER,ARG0,ARG1,ARG2,ARG3,ARG4);
		local TargetPos = random_TargetPos(ARG0,ARG1,ARG2,ARG3,false);
...
function YinYing_Update(RECEIVER,ARG0,ARG1,ARG2,ARG3,ARG4)
	local roll = math.ceil(math.random(0,100));
	if roll <= 50 then
		YinYing_PushOrder(RECEIVER,ARG0,ARG1,ARG2,ARG3,ARG4);
		local TargetPos = random_TargetPos(ARG0,ARG1,ARG2,ARG3,false);
...
function YinYing_deadth(RECEIVER, ARG0, ARG1, ARG2, ARG3,ARG4)
