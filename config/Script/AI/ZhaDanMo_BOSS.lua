...
function ZhaDanMo_PushOrder(RECEIVER,ARG0,ARG1,ARG2,ARG3,ARG4)
...
function ZhaDanMo_Born(RECEIVER,ARG0,ARG1,ARG2,ARG3,ARG4)
	local roll = math.ceil(math.random(0,100));
	if roll <= 50 then
		ZhaDanMo_PushOrder(RECEIVER,ARG0,ARG1,ARG2,ARG3,ARG4);
		local TargetPos = random_TargetPos(ARG0,ARG1,ARG2,ARG3,false);
...
function ZhaDanMo_Update(RECEIVER,ARG0,ARG1,ARG2,ARG3,ARG4)
	local roll = math.ceil(math.random(0,100));
	if roll <= 50 then
		ZhaDanMo_PushOrder(RECEIVER,ARG0,ARG1,ARG2,ARG3,ARG4);
		local TargetPos = random_TargetPos(ARG0,ARG1,ARG2,ARG3,false);
...
function ZhaDanMo_deadth(RECEIVER, ARG0, ARG1, ARG2, ARG3,ARG4)
