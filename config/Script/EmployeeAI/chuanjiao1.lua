Sys.log("load chuanjiao1.lua");

function ChuanJiao1_TongYongLiuCheng(RECEIVER, ARG0, ARG1, ARG2, ARG3,ARG4)
...
function ChuanJiao1_Born(RECEIVER, ARG0, ARG1, ARG2, ARG3,ARG4)
	...
	if table.maxn(dieTable) > 0 then
		...
		Battle.ai_pushOrder(RECEIVER,dieTable[index],2381);
		return;
	end
	--2.大于5个单位血量小于50%超补。
	--3.以上条件都不满足的话，50%攻击，50%单体魔法
	--己方血量小于50%列表
...
function ChuanJiao1_Updata(RECEIVER, ARG0, ARG1, ARG2, ARG3,ARG4)
	local myForce = check_group_type(ARG1);
	--己方死亡列表
	local dieTable = isDeadthByForce(ARG0,ARG3,myForce);
	--1.如果己方有人死了使用气绝。
...
function ChuanJiao1_deadth(RECEIVER, ARG0, ARG1, ARG2, ARG3,ARG4)
