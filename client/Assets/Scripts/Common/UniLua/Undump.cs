	...
	public class BinaryBytesReader
	{
...
#if DEBUG_BINARY_READER
			ClientLog.Instance.Log( "ReadInt: " + ret );
#endif
			return ret;
		}
...
#if DEBUG_BINARY_READER
			ClientLog.Instance.Log( "ReadUInt: " + ret );
#endif
			return ret;
		}
...
#if DEBUG_BINARY_READER
			ClientLog.Instance.Log( "ReadSizeT: " + ret );
#endif
...
#if DEBUG_BINARY_READER
			ClientLog.Instance.Log( "ReadDouble: " + ret );
#endif
			return ret;
		}
		...
		public byte ReadByte()
		{
			...
			if( c == -1 )
				throw new UndumpException("truncated");
#if DEBUG_BINARY_READER
			ClientLog.Instance.Log( "ReadBytes: " + c );
#endif
			return (byte)c;
		}
...
#if DEBUG_BINARY_READER
			ClientLog.Instance.Log( "ReadString n:" + n + " ret:" + ret );
#endif
			return ret;
		}
	}
...
#if DEBUG_UNDUMP
			ClientLog.Instance.Log(string.Format("sizeof(size_t): {0}", v));
#endif
