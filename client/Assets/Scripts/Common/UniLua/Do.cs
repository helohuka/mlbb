...
namespace UniLua
{
	...
	public partial class LuaState
	{
...
#if DEBUG_D_PRE_CALL
			ClientLog.Instance.Log( "============================ D_PreCall func:" + func );
#endif
		...
		private int D_PosCall( int firstResultIndex )
		{
...
#if DEBUG_D_POS_CALL
			ClientLog.Instance.Log( "[D] ==== PosCall enter" );
			ClientLog.Instance.Log( "[D] ==== PosCall res:" + res );
			ClientLog.Instance.Log( "[D] ==== PosCall wanted:" + wanted );
#endif
			...
			{
#if DEBUG_D_POS_CALL
				ClientLog.Instance.Log( "[D] ==== PosCall assign lhs res:" + res );
				ClientLog.Instance.Log( "[D] ==== PosCall assign rhs firstResult:" + firstResult );
#endif
			...
			{
#if DEBUG_D_POS_CALL
				ClientLog.Instance.Log( "[D] ==== PosCall new LuaNil()" );
#endif
				Stack[resIndex++].V.SetNilValue();
			}
			Top = Stack[resIndex];
#if DEBUG_D_POS_CALL
			ClientLog.Instance.Log( "[D] ==== PosCall return " + (wanted - LuaDef.LUA_MULTRET) );
#endif
