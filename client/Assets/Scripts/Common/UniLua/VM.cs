...
newframe:
...
#if DEBUG_NEW_FRAME
			ClientLog.Instance.Log( "#### NEW FRAME #########################################################################" );
			ClientLog.Instance.Log( "## cl:" + cl );
			ClientLog.Instance.Log( "## Base:" + env.Base );
			ClientLog.Instance.Log( "########################################################################################" );
#endif
			...
			while( true )
			{
				...
				ClientLog.Instance.Log( System.DateTime.Now + " [VM] ======================================================================== Instruction: " + i
				...
				switch( i.GET_OPCODE() )
				{
...
#if DEBUG_OP_MOVE
						ClientLog.Instance.Log( "[VM] ==== OP_MOVE rb:" + rb );
						ClientLog.Instance.Log( "[VM] ==== OP_MOVE ra:" + ra );
#endif
					...
					case OpCode.OP_GETUPVAL:
					{
						...
						// {
						// 	ClientLog.Instance.Log("[VM] ==== GETUPVAL upval:" + cl.Upvals[j] );
						// }
						ClientLog.Instance.Log( "[VM] ==== GETUPVAL b:" + b );
						ClientLog.Instance.Log( "[VM] ==== GETUPVAL ra:" + ra );
#endif
						break;
					}
					...
					case OpCode.OP_GETTABUP:
					{
						...
						ClientLog.Instance.Log( "[VM] ==== OP_GETTABUP key:" + key );
						ClientLog.Instance.Log( "[VM] ==== OP_GETTABUP val:" + ra );
#endif
						env.Base = ci.BaseIndex;
						break;
					}
					...
					case OpCode.OP_GETTABLE:
					{
						...
						ClientLog.Instance.Log("[VM] ==== OP_GETTABLE key:"+key.ToString());
						ClientLog.Instance.Log("[VM] ==== OP_GETTABLE val:"+val.ToString());
#endif
						break;
					}
					...
					case OpCode.OP_SETTABUP:
					{
						...
						ClientLog.Instance.Log( "[VM] ==== OP_SETTABUP key:" + key.Value );
						ClientLog.Instance.Log( "[VM] ==== OP_SETTABUP val:" + val.Value );
#endif
						env.Base = ci.BaseIndex;
						break;
					}
					...
					case OpCode.OP_SETUPVAL:
					{
						...
						ClientLog.Instance.Log( "[VM] ==== SETUPVAL b:" + b );
						ClientLog.Instance.Log( "[VM] ==== SETUPVAL ra:" + ra );
#endif
						break;
					}
					...
					case OpCode.OP_SETTABLE:
					{
						...
						ClientLog.Instance.Log( "[VM] ==== OP_SETTABLE key:" + key.ToString() );
						ClientLog.Instance.Log( "[VM] ==== OP_SETTABLE val:" + val.ToString() );
#endif
...
#if DEBUG_OP_EQ
						ClientLog.Instance.Log( "[VM] ==== OP_EQ lhs:" + lhs );
						ClientLog.Instance.Log( "[VM] ==== OP_EQ rhs:" + rhs );
						ClientLog.Instance.Log( "[VM] ==== OP_EQ expectEq:" + expectEq );
						ClientLog.Instance.Log( "[VM] ==== OP_EQ (lhs.V == rhs.V):" + (lhs.V == rhs.V) );
#endif
					...
					case OpCode.OP_TFORCALL:
					{
						...
						DumpStack( env.Base );
#if DEBUG_INSTRUCTION
						ClientLog.Instance.Log( "[VM] ============================================================ OP_TFORCALL Instruction: " + i );
#endif
...
l_tforloop:
...
#if DEBUG_OP_SETLIST
						ClientLog.Instance.Log( "[VM] ==== OP_SETLIST ci.Top:" + ci.Top.Index );
						ClientLog.Instance.Log( "[VM] ==== OP_SETLIST Top:" + Top.Index );
#endif
...
#if DEBUG_OP_CLOSURE
						ClientLog.Instance.Log( "OP_CLOSURE:" + ra.Value );
						var racl = ra.Value as LuaLClosure;
						if( racl != null )
						{
							for( int ii=0; ii<racl.Upvals.Count; ++ii )
							{
								ClientLog.Instance.Log( ii + " ) " + racl.Upvals[ii] );
							}
						}
#endif
						break;
		...
		{
			ClientLog.Instance.LogError( "[VM] ==================================== Not Implemented Instruction: " + i );
		...
		private void V_PushClosure( LuaProto p, LuaUpvalue[] encup, int stackBase, StkId ra )
		{
			...
			{
				// ClientLog.Instance.Log( "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ V_PushClosure i:" + i );
				// ClientLog.Instance.Log( "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ V_PushClosure InStack:" + p.Upvalues[i].InStack );
				// ClientLog.Instance.Log( "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ V_PushClosure Index:" + p.Upvalues[i].Index );
