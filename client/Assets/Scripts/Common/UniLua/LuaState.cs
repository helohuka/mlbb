...
namespace UniLua
{
	...
	public partial class LuaState
	{
		...
		{
			StkId.inc(ref Top);
			// ClientLog.Instance.Log( "[ApiIncrTop] ==== Top.Index:" + Top.Index );
			// ClientLog.Instance.Log( "[ApiIncrTop] ==== CI.Top.Index:" + CI.Top.Index );
		...
		public void DumpStack( int baseIndex, string tag="" )
		{
			...
			ClientLog.Instance.Log(DumpStackToString(baseIndex, tag));
#endif
		}
