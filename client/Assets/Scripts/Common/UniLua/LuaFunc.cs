...
namespace UniLua
{
	public partial class LuaState
	{
		...
		private LuaUpvalue F_FindUpval( StkId level )
		{
			...
			ClientLog.Instance.Log( "[F_FindUpval] >>>>>>>>>>>>>>>>>>>> level:" + level );
#endif
...
#if DEBUG_FIND_UPVALUE
				ClientLog.Instance.Log("[F_FindUpval] >>>>>>>>>>>>>>>>>>>> upval.V:" + upval.V );
#endif
...
#if DEBUG_FIND_UPVALUE
			ClientLog.Instance.Log("[F_FindUpval] >>>>>>>>>>>>>>>>>>>> create new one:" + ret.V );
#endif
