...
public class SellingGood : MonoBehaviour {
    ...
    public void SetData(COM_SellItem sellItem)
    {
        ...
        if (sellItem.item_.itemId_ != 0)
        {
            ...
            ItemCellUI cell = UIManager.Instance.AddItemInstCellUI(icon_, sellItem_.item_);
            cell.ItemCount = (int)sellItem.item_.stack_;
            cell.showTips = true;
        }
        else
        {
            bData = BabyData.GetData((int)sellItem.baby_.tableId_);
