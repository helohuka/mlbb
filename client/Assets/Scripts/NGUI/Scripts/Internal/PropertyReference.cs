...
public class PropertyReference
{
	...
	public bool Set (object value)
	{
		...
		if (!Convert(ref value))
		{
			if (Application.isPlaying)
				ClientLog.Instance.LogError("Unable to convert " + value.GetType() + " to " + GetPropertyType());
		}
		else if (mField != null)
		{
	...
	public object Get ()
	{
		ClientLog.Instance.LogError("Reflection is not supported on this platform");
		return null;
	}
