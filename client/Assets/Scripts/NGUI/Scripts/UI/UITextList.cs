...
public class UITextList : MonoBehaviour
{
	...
	public void Add (UIButton voice) { Add (voice, true); }
	...
	protected void Add(UIButton voice, bool updateVisible)
	{
		Paragraph ce = null;
	...
	protected void UpdateVisibleText ()
	{
		if (isValid)
		{
			...
			{
				Paragraph p = mParagraphs.buffer[i];
				int voiceLen = p.voice == null? 0: 5;
				for (int b = 0, bmax = p.lines.Length + voiceLen; maxLines > 0 && b < bmax; ++b)
				{
					string s = p.lines[b];
