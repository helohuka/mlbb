...
public class ChatInput : MonoBehaviour
{
	...
	public GameObject sendBtn_;
	public UIButton voiceBtn_;
	public UIButton defvoice;
	UIInput mInput;
...
//			}
//		}
//		PrebattleEvent.getInstance.ReceiveEvent = Receive;
//		UIEventListener.Get (sendBtn_).onClick = OnSubmit;
		//UIEventListener.Get (voiceBtn_.gameObject).onClick = OnSubmits;
	}
...
//				if(mInput.value[0] == '^')
//
//					//NetConnection.Instance.sendChat(ChatKind.CK_GM, mInput.value.Substring(1),"");
//				else
					//NetConnection.Instance.sendChat (ChatKind.CK_World, mInput.value,"");
				mInput.value = "";
	...
	public void OnSubmits(GameObject sender)
	{

		textList.Add (defvoice);
	}
