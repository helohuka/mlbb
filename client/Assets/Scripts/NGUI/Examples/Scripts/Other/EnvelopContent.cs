...
public class EnvelopContent : MonoBehaviour
{
	...
	public void Execute ()
	{
		...
		{
			ClientLog.Instance.LogError("Target Root object cannot be the same object that has Envelop Content. Make it a sibling instead.", this);
		}
		else if (NGUITools.IsChild(targetRoot, transform))
		{
			ClientLog.Instance.LogError("Target Root object should not be a parent of Envelop Content. Make it a sibling instead.", this);
		}
		else
		{
